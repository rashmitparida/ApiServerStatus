...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "rashmi.sunshine.20@gmail.com"};
	static String fromUser = "rashmita.parida2";//just the id alone without @gmail.com
	static String password = "luvususki@143";
